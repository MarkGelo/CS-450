   ...
   e:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  25:	e8 36 04 00 00       	call   460 <printf>
    exit();
  2a:	e8 d4 02 00 00       	call   303 <exit>
  }

  n = atoi(argv[1]);
  2f:	83 ec 0c             	sub    $0xc,%esp
  32:	ff 70 04             	pushl  0x4(%eax)
  35:	e8 56 02 00 00       	call   290 <atoi>
  ...
  4f:	e8 1c 00 00 00       	call   70 <recurse>
  printf(1, "Lab 3: Yielded a value of %d\n", m);
  54:	83 c4 0c             	add    $0xc,%esp
  57:	50                   	push   %eax
  58:	68 f6 07 00 00       	push   $0x7f6
  5d:	6a 01                	push   $0x1
  5f:	e8 fc 03 00 00       	call   460 <printf>
  exit();
  64:	e8 9a 02 00 00       	call   303 <exit>
  69:	66 90                	xchg   %ax,%ax
  6b:	66 90                	xchg   %ax,%ax
  6d:	66 90                	xchg   %ax,%ax
  6f:	90                   	nop
...
00000070 <recurse>:
{
  ...
  if(n == 0)
  7a:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
  7e:	75 07                	jne    87 <recurse+0x17>
    return 0;
  80:	b8 00 00 00 00       	mov    $0x0,%eax
  85:	eb 17                	jmp    9e <recurse+0x2e>
  return n + recurse(n - 1);
  87:	8b 45 08             	mov    0x8(%ebp),%eax
  8a:	83 e8 01             	sub    $0x1,%eax
  8d:	83 ec 0c             	sub    $0xc,%esp
  90:	50                   	push   %eax
  91:	e8 da ff ff ff       	call   70 <recurse>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb 14 08 00 00       	mov    $0x814,%ebx
        while(*s != 0){
